<!--
PR template. Agents and humans must fill every section.
Delete sections that genuinely do not apply, but explain why.
-->
...
<sub>Generated/edited by an agent? Tag with `agent` label and include the agent name + run id in the notes section.</sub>
